...
const COMPANIES = [
  ...
  { id:5,  name:"1047 Games",          stage:"series_c_plus", sector:["Gaming","AI"],                       city:"Las Vegas",      region:"las_vegas", funding:120,  momentum:72, employees:100,  founded:2017, description:"Game studio behind Splitgate. Founded in Stanford dorm room. Over $120M raised. Fully remote team.", eligible:[], lat:36.17, lng:-115.14 },
  { id:6,  name:"Hubble Network",      stage:"series_b",      sector:["IoT","Aerospace","Satellite"],       city:"Las Vegas",      region:"las_vegas", funding:100,  momentum:86, employees:46,   founded:2021, description:"Satellite-powered Bluetooth network. First BLE-to-satellite connection ever. 7 satellites in orbit. Partners with Life360/Tile (90M+ devices).", eligible:[], lat:36.17, lng:-115.14 },
  // === SERIES A / B (verified) ===
  { id:7,  name:"Boxabl",              stage:"series_a",      sector:["Construction","Manufacturing"],       city:"N. Las Vegas",   region:"las_vegas", funding:75,   momentum:76, employees:200,  founded:2017, description:"Foldable modular housing. The Casita unfolds into a full-size room in under an hour. 100K+ reservation waitlist. Reg A+ offering.", eligible:[], lat:36.24, lng:-115.12 },
  ...
  { id:13, name:"Protect AI",          stage:"series_b",      sector:["AI","Cybersecurity"],                  city:"Las Vegas",      region:"las_vegas", funding:18.5, momentum:80, employees:60,   founded:2022, description:"AI and ML security platform. Helps organizations manage security risks from AI systems. Huntr bug bounty for AI.", eligible:[], lat:36.17, lng:-115.14 },
  ...
  { id:26, name:"SEE ID",              stage:"seed",          sector:["AI","Identity","Cybersecurity"],        city:"Las Vegas",      region:"las_vegas", funding:0.6,  momentum:50, employees:5,    founded:2023, description:"Visual identity verification using AI for in-person and remote interactions. FundNV seed investment.", eligible:["fundnv","1864","bbv"], lat:36.17, lng:-115.14 },
  ...
  { id:29, name:"Lyten",               stage:"growth",        sector:["Cleantech","Manufacturing","Energy"],   city:"Reno",           region:"reno",      funding:425,  momentum:92, employees:200,  founded:2015, description:"Lithium-sulfur battery pioneer. $1B+ gigafactory planned at Reno AirLogistics Park. 40% lighter than Li-ion. Backed by Stellantis, FedEx, Honeywell. 1,000+ jobs at full capacity.", eligible:[], lat:39.53, lng:-119.81 },
  ...
  { id:34, name:"Filament Health",     stage:"series_a",      sector:["Biotech","Healthcare"],                city:"Reno",           region:"reno",      funding:8,    momentum:54, employees:22,   founded:2020, description:"Standardized natural psilocybin for clinical trials and pharmaceutical development. Drug master file with FDA.", eligible:[], lat:39.53, lng:-119.81 },
  ...
  { id:41, name:"Hibear",              stage:"seed",          sector:["Consumer","Manufacturing"],              city:"Las Vegas",      region:"las_vegas", funding:1.2,  momentum:58, employees:6,    founded:2022, description:"Multifunctional hydro flask with integrated brewing and filtering. StartUpNV portfolio company. Featured on Shark Tank April 2024. Nevada Dealroom ecosystem member.", eligible:["fundnv","bbv"], lat:36.17, lng:-115.14 },
  ...
  { id:45, name:"Lucihub",             stage:"seed",          sector:["AI","Media"],                          city:"Las Vegas",      region:"las_vegas", funding:3.2,  momentum:62, employees:12,   founded:2022, description:"AI-powered video production and editing. Automated storyboarding and post-production. CES Innovation Award.", eligible:["fundnv","1864","bbv"], lat:36.17, lng:-115.14 },
  ...
  { id:52, name:"Nevada Nano",         stage:"series_a",      sector:["Defense","IoT","Semiconductors"],      city:"Las Vegas",      region:"las_vegas", funding:8,    momentum:66, employees:25,   founded:2013, description:"MEMS-based environmental sensing chips. Precise gas detection for defense, industrial, and air quality monitoring.", eligible:["sbir"], lat:36.17, lng:-115.14 },
  // === HOSPITALITY / ENTERTAINMENT TECH ===
  { id:53, name:"Duetto",              stage:"series_c_plus", sector:["AI","Hospitality","Analytics"],           city:"Las Vegas",      region:"las_vegas", funding:80,   momentum:72, employees:200,  founded:2012, description:"AI-powered hotel revenue management platform. Dynamic pricing for gaming resorts and hospitality. Used by major casino operators worldwide. Las Vegas-based engineering hub.", eligible:[], lat:36.17, lng:-115.14 },
  ...
  { id:63, name:"BuildQ",              stage:"seed",          sector:["AI","Construction","Cleantech"],         city:"Las Vegas",      region:"las_vegas", funding:0.4,  momentum:68, employees:8,    founded:2024, description:"AI-powered project finance platform for renewable energy infrastructure. Streamlines complex financing for developers. AngelNV 2025 winner. First FundNV2 investment ($200K with SSBCI match).", eligible:["fundnv","1864","bbv"], lat:36.17, lng:-115.14 },
  { id:64, name:"Nuvve Corp",          stage:"growth",        sector:["Energy","Logistics","IoT"],            city:"Las Vegas",      region:"las_vegas", funding:40,   momentum:52, employees:50,   founded:2019, description:"Vehicle-to-grid (V2G) technology for electric buses and fleet vehicles. Smart charging infrastructure.", eligible:[], lat:36.17, lng:-115.14 },
  // === EDUCATION / WORKFORCE ===
  ...
  { id:69, name:"Acres Technology",    stage:"series_a",      sector:["Gaming","Fintech","IoT"],              city:"Las Vegas",      region:"las_vegas", funding:12,   momentum:62, employees:35,   founded:2013, description:"Foundation casino management platform. Cashless gaming, player loyalty, and real-time analytics for slot floors.", eligible:[], lat:36.17, lng:-115.14 },
  ...
  // === AEROSPACE / SPACE ===
  { id:72, name:"Skydio Gov",          stage:"series_a",      sector:["Defense","AI","Drones"],                city:"Las Vegas",      region:"las_vegas", funding:10,   momentum:74, employees:30,   founded:2021, description:"Government and defense drone operations center supporting autonomous UAS missions at NTTR and Nellis AFB. Counter-UAS testing and AI-powered ISR. Nevada operations hub.", eligible:["sbir"], lat:36.24, lng:-115.04 },
  // === MANUFACTURING / MATERIALS ===
  { id:73, name:"Aqua Metals",         stage:"growth",        sector:["Cleantech","Manufacturing"],           city:"Reno",           region:"reno",      funding:120,  momentum:52, employees:80,   founded:2014, description:"Clean battery recycling with AquaRefining. Non-polluting lead recycling. NYSE American: AQMS. TRIC facility.", eligible:[], lat:39.53, lng:-119.81 },
  ...
  // === BBV PORTFOLIO COMPANIES (Battle Born Venture — SSBCI co-investment fund) ===
  { id:76,  name:"Access Health Dental",  stage:"seed",     sector:["Healthcare","Consumer"],              city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:50, employees:10,  founded:2020, description:"Dental health access and services platform. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:77,  name:"Adaract",              stage:"seed",     sector:["AI","Enterprise"],                    city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:48, employees:8,   founded:2021, description:"Enterprise technology solutions. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:78,  name:"AI Foundation",         stage:"seed",     sector:["AI","Consumer"],                      city:"Las Vegas",      region:"las_vegas", funding:1.0,  momentum:52, employees:12,  founded:2020, description:"AI-powered consumer applications. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:79,  name:"AIR Corp",             stage:"seed",     sector:["Cleantech","IoT"],                    city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:50, employees:8,   founded:2021, description:"Air quality and environmental monitoring technology. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:80,  name:"Battle Born Beer",     stage:"seed",     sector:["Consumer","Manufacturing"],            city:"Las Vegas",      region:"las_vegas", funding:0.3,  momentum:46, employees:6,   founded:2019, description:"Nevada craft beer brand. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:81,  name:"Beloit Kombucha",      stage:"seed",     sector:["Consumer","Manufacturing"],            city:"Las Vegas",      region:"las_vegas", funding:0.3,  momentum:44, employees:5,   founded:2020, description:"Craft kombucha beverage brand. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:82,  name:"BrakeSens",            stage:"seed",     sector:["IoT","Automotive"],                   city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:52, employees:8,   founded:2021, description:"Brake sensor technology for automotive safety. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:83,  name:"Carewear",             stage:"seed",     sector:["Healthcare","IoT","Biotech"],          city:"Las Vegas",      region:"las_vegas", funding:1.0,  momentum:56, employees:12,  founded:2019, description:"Wearable medical device technology for pain management and recovery. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:84,  name:"CircleIn",             stage:"seed",     sector:["Education","AI"],                     city:"Las Vegas",      region:"las_vegas", funding:0.8,  momentum:54, employees:10,  founded:2018, description:"Student engagement and community platform for higher education. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:85,  name:"Click Bio",            stage:"seed",     sector:["Consumer","AI","Media"],               city:"Las Vegas",      region:"las_vegas", funding:0.3,  momentum:48, employees:5,   founded:2021, description:"Bio link and social media management platform. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:86,  name:"Clothesline",          stage:"seed",     sector:["Consumer","Retail"],                   city:"Las Vegas",      region:"las_vegas", funding:0.3,  momentum:46, employees:5,   founded:2020, description:"Fashion and apparel marketplace platform. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:87,  name:"Coco Coders",          stage:"seed",     sector:["Education","AI"],                     city:"Las Vegas",      region:"las_vegas", funding:0.3,  momentum:48, employees:6,   founded:2021, description:"Coding education platform for youth. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:88,  name:"Create Good Foods",    stage:"seed",     sector:["Consumer","Manufacturing"],            city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:50, employees:8,   founded:2019, description:"Health-focused food brand and consumer products. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:89,  name:"Cuts Clothing",        stage:"seed",     sector:["Consumer","Retail"],                   city:"Las Vegas",      region:"las_vegas", funding:1.5,  momentum:62, employees:20,  founded:2018, description:"Premium men's performance apparel brand. Direct-to-consumer. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:90,  name:"Daya Medical",         stage:"seed",     sector:["Healthcare","Biotech"],                city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:50, employees:8,   founded:2020, description:"Medical device and healthcare innovation company. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:91,  name:"Dog Whistle",          stage:"seed",     sector:["Consumer","AI"],                      city:"Las Vegas",      region:"las_vegas", funding:0.3,  momentum:46, employees:5,   founded:2021, description:"Consumer technology product. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:92,  name:"Drain Drawer",         stage:"seed",     sector:["Consumer","Manufacturing"],            city:"Las Vegas",      region:"las_vegas", funding:0.3,  momentum:44, employees:4,   founded:2020, description:"Kitchen and home innovation product. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:93,  name:"Ecoatoms",             stage:"seed",     sector:["Cleantech","Materials Science"],       city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:52, employees:8,   founded:2021, description:"Clean materials and sustainable technology company. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:94,  name:"Elly Health",           stage:"seed",     sector:["Healthcare","AI"],                    city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:52, employees:8,   founded:2020, description:"Health and wellness technology platform. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:95,  name:"Fandeavor",            stage:"seed",     sector:["Consumer","Hospitality","Analytics"],  city:"Las Vegas",      region:"las_vegas", funding:1.0,  momentum:54, employees:12,  founded:2017, description:"Fan experience and sports entertainment platform. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:96,  name:"Fanup",                stage:"seed",     sector:["Consumer","Gaming","Media"],           city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:48, employees:6,   founded:2019, description:"Fan engagement and social sports platform. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:97,  name:"Grantcycle",           stage:"seed",     sector:["Fintech","Enterprise"],                city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:52, employees:8,   founded:2020, description:"Grant management and funding cycle platform. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:98,  name:"Grrrl",                stage:"seed",     sector:["Consumer","Fitness"],                  city:"Las Vegas",      region:"las_vegas", funding:0.8,  momentum:56, employees:10,  founded:2018, description:"Women's fitness and strength brand. Activewear and empowerment community. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:99,  name:"Heligenics",           stage:"seed",     sector:["Biotech","Healthcare"],                city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:50, employees:8,   founded:2020, description:"Life sciences and biotechnology company. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:100, name:"Know Risk",            stage:"seed",     sector:["AI","Analytics","Insurance"],          city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:50, employees:8,   founded:2020, description:"Risk assessment and analytics platform. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:101, name:"Let's Rolo",           stage:"seed",     sector:["Consumer","AI"],                      city:"Las Vegas",      region:"las_vegas", funding:0.3,  momentum:48, employees:6,   founded:2021, description:"Social networking and contact sharing platform. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:102, name:"Longshot Technologies",stage:"seed",     sector:["Defense","IoT","Analytics"],           city:"Las Vegas",      region:"las_vegas", funding:1.0,  momentum:58, employees:12,  founded:2019, description:"Defense and sports technology for precision tracking and analytics. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:103, name:"Melzi",                stage:"seed",     sector:["AI","Education"],                     city:"Las Vegas",      region:"las_vegas", funding:0.3,  momentum:48, employees:6,   founded:2021, description:"AI-powered creative and educational technology. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:104, name:"Nailstry",             stage:"seed",     sector:["Consumer","Retail"],                   city:"Las Vegas",      region:"las_vegas", funding:0.3,  momentum:46, employees:5,   founded:2020, description:"Nail care services and beauty platform. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:105, name:"Neuroreserve",         stage:"seed",     sector:["Healthcare","Biotech","AI"],           city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:52, employees:8,   founded:2020, description:"Neurological health and brain wellness technology. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:106, name:"Nivati",               stage:"seed",     sector:["Healthcare","AI","HR Tech"],           city:"Las Vegas",      region:"las_vegas", funding:1.0,  momentum:56, employees:15,  founded:2019, description:"Employee mental health and wellness platform for enterprises. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:107, name:"Onboarded",            stage:"seed",     sector:["HR Tech","AI","Enterprise"],           city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:52, employees:8,   founded:2020, description:"Employee onboarding and training automation platform. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:108, name:"Otsy",                 stage:"seed",     sector:["Consumer","AI"],                      city:"Las Vegas",      region:"las_vegas", funding:0.3,  momentum:46, employees:5,   founded:2021, description:"Consumer technology platform. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:109, name:"Phone2",               stage:"seed",     sector:["Consumer","IoT"],                     city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:50, employees:8,   founded:2020, description:"Communications and phone technology platform. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:110, name:"Prosper Technologies", stage:"seed",     sector:["Fintech","AI"],                       city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:52, employees:8,   founded:2020, description:"Financial technology and prosperity tools. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:111, name:"Quantum Copper",       stage:"seed",     sector:["Mining","Materials Science"],          city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:50, employees:8,   founded:2021, description:"Copper mining and materials technology. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:112, name:"Sarcomatrix",          stage:"seed",     sector:["Biotech","Healthcare"],                city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:50, employees:8,   founded:2020, description:"Cancer research and oncology biotechnology company. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:113, name:"Semi Exact",           stage:"seed",     sector:["Semiconductors","Manufacturing"],      city:"Las Vegas",      region:"las_vegas", funding:1.0,  momentum:54, employees:10,  founded:2020, description:"Semiconductor and precision manufacturing technology. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:114, name:"Surgistream",          stage:"seed",     sector:["Healthcare","AI","Enterprise"],        city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:52, employees:8,   founded:2020, description:"Surgical workflow and healthcare operations platform. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:115, name:"Taber Innovations",    stage:"seed",     sector:["IoT","Manufacturing"],                city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:50, employees:8,   founded:2020, description:"Hardware and innovation product company. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:116, name:"Talage Insurance",     stage:"seed",     sector:["Insurance","Fintech","AI"],            city:"Las Vegas",      region:"las_vegas", funding:1.5,  momentum:58, employees:15,  founded:2018, description:"Insurtech platform simplifying commercial insurance for small businesses. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:117, name:"Terbine",              stage:"seed",     sector:["IoT","AI","Analytics"],                city:"Las Vegas",      region:"las_vegas", funding:1.0,  momentum:54, employees:10,  founded:2017, description:"IoT data exchange and analytics platform for machine-generated data. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:118, name:"TransWorldHealth",     stage:"seed",     sector:["Healthcare","AI"],                    city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:50, employees:8,   founded:2020, description:"Global health technology and telemedicine platform. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:119, name:"Ultion",               stage:"seed",     sector:["Cybersecurity","IoT"],                 city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:52, employees:8,   founded:2020, description:"Security technology and access control solutions. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:120, name:"Vena Solutions",       stage:"seed",     sector:["Fintech","Enterprise","Analytics"],    city:"Las Vegas",      region:"las_vegas", funding:1.0,  momentum:54, employees:12,  founded:2019, description:"Financial planning and analysis software platform. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:121, name:"Vena Vitals",          stage:"seed",     sector:["Healthcare","IoT","Biotech"],          city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:52, employees:8,   founded:2020, description:"Health monitoring and vital signs technology. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:122, name:"Vision Aid",           stage:"seed",     sector:["Healthcare","AI","IoT"],               city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:50, employees:8,   founded:2020, description:"Visual assistive technology and accessibility solutions. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:123, name:"Vistro",               stage:"seed",     sector:["Energy","AI","Analytics"],             city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:52, employees:8,   founded:2020, description:"Energy technology and utility solutions platform. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:124, name:"Wavr",                 stage:"seed",     sector:["Consumer","IoT","Media"],              city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:50, employees:6,   founded:2020, description:"Audio and immersive media technology. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:125, name:"Wedgies",              stage:"seed",     sector:["Consumer","Media","Analytics"],         city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:48, employees:6,   founded:2017, description:"Social polling and audience engagement platform. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:126, name:"Wise Banyan",          stage:"seed",     sector:["Fintech","AI"],                       city:"Las Vegas",      region:"las_vegas", funding:1.0,  momentum:52, employees:10,  founded:2016, description:"Robo-advisor and automated financial planning platform. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
  { id:127, name:"Zencentiv",            stage:"seed",     sector:["Enterprise","Fintech"],                city:"Las Vegas",      region:"las_vegas", funding:0.5,  momentum:50, employees:8,   founded:2020, description:"Incentive management and business rewards platform. Battle Born Venture portfolio company.", eligible:["bbv"], lat:36.17, lng:-115.14 },
];

const FUNDS = [
  { id:"bbv",    name:"Battle Born Venture", type:"SSBCI",         allocated:36,   deployed:14.8, leverage:3.2, companies:59, thesis:"Co-invest alongside private lead investors in NV tech startups via SSBCI match" },
...
// === Battle Born Venture (f_bbv) invested_in edges — full portfolio ===
// Note: f_bbv → c_4 (TensorWave) already exists above
{source:"f_bbv",target:"c_11",rel:"invested_in",note:"BBV co-investment in CIQ.",y:2023},
{source:"f_bbv",target:"c_26",rel:"invested_in",note:"BBV co-investment in SEE ID.",y:2023},
{source:"f_bbv",target:"c_36",rel:"invested_in",note:"BBV co-investment in Tilt.",y:2023},
{source:"f_bbv",target:"c_41",rel:"invested_in",note:"BBV co-investment in Hibear.",y:2023},
{source:"f_bbv",target:"c_45",rel:"invested_in",note:"BBV co-investment in Lucihub.",y:2023},
{source:"f_bbv",target:"c_63",rel:"invested_in",note:"BBV co-investment in BuildQ.",y:2023},
{source:"f_bbv",target:"c_76",rel:"invested_in",note:"BBV co-investment in Access Health Dental.",y:2023},
{source:"f_bbv",target:"c_77",rel:"invested_in",note:"BBV co-investment in Adaract.",y:2023},
{source:"f_bbv",target:"c_78",rel:"invested_in",note:"BBV co-investment in AI Foundation.",y:2023},
{source:"f_bbv",target:"c_79",rel:"invested_in",note:"BBV co-investment in AIR Corp.",y:2023},
{source:"f_bbv",target:"c_80",rel:"invested_in",note:"BBV co-investment in Battle Born Beer.",y:2023},
{source:"f_bbv",target:"c_81",rel:"invested_in",note:"BBV co-investment in Beloit Kombucha.",y:2023},
{source:"f_bbv",target:"c_82",rel:"invested_in",note:"BBV co-investment in BrakeSens.",y:2023},
{source:"f_bbv",target:"c_83",rel:"invested_in",note:"BBV co-investment in Carewear.",y:2023},
{source:"f_bbv",target:"c_84",rel:"invested_in",note:"BBV co-investment in CircleIn.",y:2023},
{source:"f_bbv",target:"c_85",rel:"invested_in",note:"BBV co-investment in Click Bio.",y:2023},
{source:"f_bbv",target:"c_86",rel:"invested_in",note:"BBV co-investment in Clothesline.",y:2023},
{source:"f_bbv",target:"c_87",rel:"invested_in",note:"BBV co-investment in Coco Coders.",y:2023},
{source:"f_bbv",target:"c_88",rel:"invested_in",note:"BBV co-investment in Create Good Foods.",y:2023},
{source:"f_bbv",target:"c_89",rel:"invested_in",note:"BBV co-investment in Cuts Clothing.",y:2023},
{source:"f_bbv",target:"c_90",rel:"invested_in",note:"BBV co-investment in Daya Medical.",y:2023},
{source:"f_bbv",target:"c_91",rel:"invested_in",note:"BBV co-investment in Dog Whistle.",y:2023},
{source:"f_bbv",target:"c_92",rel:"invested_in",note:"BBV co-investment in Drain Drawer.",y:2023},
{source:"f_bbv",target:"c_93",rel:"invested_in",note:"BBV co-investment in Ecoatoms.",y:2023},
{source:"f_bbv",target:"c_94",rel:"invested_in",note:"BBV co-investment in Elly Health.",y:2023},
{source:"f_bbv",target:"c_95",rel:"invested_in",note:"BBV co-investment in Fandeavor.",y:2023},
{source:"f_bbv",target:"c_96",rel:"invested_in",note:"BBV co-investment in Fanup.",y:2023},
{source:"f_bbv",target:"c_97",rel:"invested_in",note:"BBV co-investment in Grantcycle.",y:2023},
{source:"f_bbv",target:"c_98",rel:"invested_in",note:"BBV co-investment in Grrrl.",y:2023},
{source:"f_bbv",target:"c_99",rel:"invested_in",note:"BBV co-investment in Heligenics.",y:2023},
{source:"f_bbv",target:"c_100",rel:"invested_in",note:"BBV co-investment in Know Risk.",y:2023},
{source:"f_bbv",target:"c_101",rel:"invested_in",note:"BBV co-investment in Let's Rolo.",y:2023},
{source:"f_bbv",target:"c_102",rel:"invested_in",note:"BBV co-investment in Longshot Technologies.",y:2023},
{source:"f_bbv",target:"c_103",rel:"invested_in",note:"BBV co-investment in Melzi.",y:2023},
{source:"f_bbv",target:"c_104",rel:"invested_in",note:"BBV co-investment in Nailstry.",y:2023},
{source:"f_bbv",target:"c_105",rel:"invested_in",note:"BBV co-investment in Neuroreserve.",y:2023},
{source:"f_bbv",target:"c_106",rel:"invested_in",note:"BBV co-investment in Nivati.",y:2023},
{source:"f_bbv",target:"c_107",rel:"invested_in",note:"BBV co-investment in Onboarded.",y:2023},
{source:"f_bbv",target:"c_108",rel:"invested_in",note:"BBV co-investment in Otsy.",y:2023},
{source:"f_bbv",target:"c_109",rel:"invested_in",note:"BBV co-investment in Phone2.",y:2023},
{source:"f_bbv",target:"c_110",rel:"invested_in",note:"BBV co-investment in Prosper Technologies.",y:2023},
{source:"f_bbv",target:"c_111",rel:"invested_in",note:"BBV co-investment in Quantum Copper.",y:2023},
{source:"f_bbv",target:"c_112",rel:"invested_in",note:"BBV co-investment in Sarcomatrix.",y:2023},
{source:"f_bbv",target:"c_113",rel:"invested_in",note:"BBV co-investment in Semi Exact.",y:2023},
{source:"f_bbv",target:"c_114",rel:"invested_in",note:"BBV co-investment in Surgistream.",y:2023},
{source:"f_bbv",target:"c_115",rel:"invested_in",note:"BBV co-investment in Taber Innovations.",y:2023},
{source:"f_bbv",target:"c_116",rel:"invested_in",note:"BBV co-investment in Talage Insurance.",y:2023},
{source:"f_bbv",target:"c_117",rel:"invested_in",note:"BBV co-investment in Terbine.",y:2023},
{source:"f_bbv",target:"c_118",rel:"invested_in",note:"BBV co-investment in TransWorldHealth.",y:2023},
{source:"f_bbv",target:"c_119",rel:"invested_in",note:"BBV co-investment in Ultion.",y:2023},
{source:"f_bbv",target:"c_120",rel:"invested_in",note:"BBV co-investment in Vena Solutions.",y:2023},
{source:"f_bbv",target:"c_121",rel:"invested_in",note:"BBV co-investment in Vena Vitals.",y:2023},
{source:"f_bbv",target:"c_122",rel:"invested_in",note:"BBV co-investment in Vision Aid.",y:2023},
{source:"f_bbv",target:"c_123",rel:"invested_in",note:"BBV co-investment in Vistro.",y:2023},
{source:"f_bbv",target:"c_124",rel:"invested_in",note:"BBV co-investment in Wavr.",y:2023},
{source:"f_bbv",target:"c_125",rel:"invested_in",note:"BBV co-investment in Wedgies.",y:2023},
{source:"f_bbv",target:"c_126",rel:"invested_in",note:"BBV co-investment in Wise Banyan.",y:2023},
{source:"f_bbv",target:"c_127",rel:"invested_in",note:"BBV co-investment in Zencentiv.",y:2023},
