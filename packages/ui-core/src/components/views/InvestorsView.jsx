...
import { GOLD, DARK, CARD, BORDER, TEXT, MUTED, GREEN, BLUE, PURPLE } from '../../styles/tokens.js';
import { STAGE_COLORS, fmt, stageLabel } from '../../engine/formatters.js';

export default function InvestorsView({ viewProps }) {
  const {
    data, allScored, isMobile,
    setSelectedCompany, fundDetail, setFundDetail,
  } = viewProps;
