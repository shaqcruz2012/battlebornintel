...
import { CARD, BORDER, DARK, MUTED, GOLD, GREEN, BLUE, TEXT, STAGE_COLORS, TRIGGER_CFG, GRADE_COLORS, fmt, stageLabel } from "@bbi/ui-core";
import Grade from "./Grade.jsx";

const DetailPanel = ({ selectedCompany, setSelectedCompany, isMobile }) => {
