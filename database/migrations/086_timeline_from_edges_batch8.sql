-- Migration 086: Generate timeline_events from verified graph_edges for companies 113-127
-- (Semi Exact, SurgiStream, Taber Innovations, Talage Insurance, Terbine,
--  TransWorldHealth, Ultion, Vena Solutions, Vena Vitals, VisionAid,
--  Vistro, WAVR Technologies, Wedgies, WiseBanyan, ZenCentiv)
...
FROM (
  ...
  WHERE c.id BETWEEN 113 AND 127
