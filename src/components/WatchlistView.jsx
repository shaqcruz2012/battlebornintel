import { GOLD, CARD, BORDER, TEXT, MUTED, GREEN, RED, STAGE_COLORS, TRIGGER_CFG, GRADE_COLORS, fadeIn } from "../lib/constants";
import { fmt, stageLabel } from "../lib/formatters";
import { Stat, Grade } from "./shared";

export default function WatchlistView({ watchlist, setWatchlist, watchedCompanies, isMobile, setSelectedCompany, setView, toggleWatchlist }) {
  return (
