import { GOLD, CARD, BORDER, TEXT, MUTED, GREEN, STAGE_COLORS, fadeIn } from "../lib/constants";
import { fmt, stageLabel } from "../lib/formatters";
import { MBar } from "./shared";

export default function CompanyList({ filtered, search, setSearch, stageFilter, setStageFilter, regionFilter, setRegionFilter, sortBy, setSortBy, selectedCompany, setSelectedCompany, compareList, setCompareList, toggleWatchlist, isWatched, isMobile }) {
  return (
    <div style={fadeIn}>
