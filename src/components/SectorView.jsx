import { GOLD, CARD, BORDER, TEXT, MUTED, GREEN, ORANGE, STAGE_COLORS, fadeIn } from "../lib/constants";
import { fmt, stageLabel } from "../lib/formatters";
import { Stat, Grade } from "./shared";

export default function SectorView({ sectorStats, sectorDetail, setSectorDetail, isMobile, setSelectedCompany, toggleWatchlist, isWatched }) {
  if (sectorDetail) {
    return (
