...
export function KpiStrip({ kpis, funds = [], activeSortBy, onSortChange }) {
  ...
  const sparkSsbciCapital = useMemo(() => [8, 12, 15, 18, 22, kpis.ssbciCapitalDeployed.value], [kpis.ssbciCapitalDeployed.value]);
  ...
  return (
    <div className={styles.strip}>
      ...
      />
      <KpiCard
        label={kpis.ssbciCapitalDeployed.label}
        value={kpis.ssbciCapitalDeployed.value}
        prefix="$"
        suffix="M"
        decimals={1}
