import { SHEAT, STAGE_NORMS } from '../data/constants.js';
...
export function computeIRS(c) {
  ...
  if (c.eligible.some((e) => ["bbv", "fundnv", "1864"].includes(e))) triggers.push("ssbci_eligible");
  if (hs >= 50) triggers.push("hiring_surge");
  if (m >= 80) triggers.push("high_momentum");
  if (c.eligible.includes("sbir")) triggers.push("grant_validated");
