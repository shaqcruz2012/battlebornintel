...
Reads all timestamped interactions from PostgreSQL and produces training-ready
files for PyTorch Geometric Temporal:

  temporal_edges.csv  — (source, target, timestamp, rel_idx, efeat_0..efeat_15)
  node_features.csv   — (node_idx, feat_0 .. feat_39)
